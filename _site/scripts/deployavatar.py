...
yaml_file_path = "/home/hlynden/My Repos/harvey0100.github.io/_data/autils/modules.yml"
...
for module in modules:
    ...
    for maintainer in module.get("maintainers", []):
        github_username = maintainer.get("github_usr_name", "") or maintainer.get(
            "github_usr_name:", ""
        )
        ...
        if github_username:
            ...
            if response.status_code == 200:
                ...
                maintainer["maintainer_image"] = user_data.get(
                    "avatar_url", maintainer.get("maintainer_image")
                )
                logging.debug(
